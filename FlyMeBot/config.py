...
class DefaultConfig:
    ...
    PORT = 3978
    APP_ID = os.environ.get("MicrosoftAppId", "34eb7b5c-ab41-46f0-b40f-fcbe19c4b1e9")
    APP_PASSWORD = os.environ.get("MicrosoftAppPassword", "B|Pu4NbbGCv%1Y;qgd_/qVzk1RxP")
