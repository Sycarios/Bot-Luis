...
class DateResolverDialog2(CancelAndHelpDialog):
    """Resolve the date"""
    ...
    def __init__(
        ...
        super(DateResolverDialog2, self).__init__(
            dialog_id or DateResolverDialog2.__name__, telemetry_client
        )
        self.telemetry_client = telemetry_client

        date_time_prompt = DateTimePrompt(
            DateTimePrompt.__name__, DateResolverDialog2.datetime_prompt_validator
        )
        date_time_prompt.telemetry_client = telemetry_client
